...
**YOU ARE IN: `hollingsbot3/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/hollingsbot3/` (rig root) or other directories
...
**Your mail address:** `hollingsbot3/polecats/obsidian`
**Your rig:** hollingsbot3
**Your Witness:** `hollingsbot3/witness`
...
| Ask Witness for help | `gt mail send hollingsbot3/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`hollingsbot3/witness`) when:
...
```bash
gt mail send hollingsbot3/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
